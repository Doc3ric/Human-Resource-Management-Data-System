...
class Report1Export implements FromView, WithTitle, ShouldAutoSize, WithStyles, WithEvents, WithDrawings, WithCustomStartCell
{
    ...
    {
        return 'Report 1 - By Office';
    }

    public function view(): View
    {
        return view('exports.reports.report1-excel', $this->data);
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue('A1', 'Inventory of Provincial Government Personnel — By Office & Appointment Type');
