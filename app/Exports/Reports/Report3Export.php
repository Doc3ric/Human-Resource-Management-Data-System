...
class Report3Export implements FromView, WithTitle, ShouldAutoSize, WithStyles, WithEvents, WithDrawings, WithCustomStartCell
{
    ...
    {
        return 'Report 3 - Hired Promoted';
    }

    public function view(): View
    {
        return view('exports.reports.report3-excel', $this->data);
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue('A1', 'Newly Hired, Promoted & Demoted Employees — ' . $this->data['year']);
