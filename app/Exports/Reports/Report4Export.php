...
class Report4Export implements FromView, WithTitle, ShouldAutoSize, WithStyles, WithEvents, WithDrawings, WithCustomStartCell
{
    ...
    {
        return 'Report 4 - Retirees';
    }

    public function view(): View
    {
        return view('exports.reports.report4-excel', $this->data);
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue('A1', 'List of Retirees — ' . $this->data['year']);
