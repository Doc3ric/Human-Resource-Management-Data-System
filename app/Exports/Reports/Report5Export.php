...
class Report5Export implements FromView, WithTitle, ShouldAutoSize, WithStyles, WithEvents, WithDrawings, WithCustomStartCell
{
    ...
    {
        return 'Report 5 - Separated';
    }

    public function view(): View
    {
        return view('exports.reports.report5-excel', $this->data);
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue('A1', 'Separated / Terminated Employees — ' . $this->data['year']);
