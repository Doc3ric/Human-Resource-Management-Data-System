...
/** Enhancement Spec Sec. 5 — Report: Detailed Employees. */
class Report8Export implements FromView, WithTitle, ShouldAutoSize, WithStyles, WithEvents, WithDrawings, WithCustomStartCell
{
    ...
    {
        return 'Report 8 - Detailed Employees';
    }

    public function view(): View
    {
        return view('exports.reports.report8-excel', $this->data);
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue('A1', 'Detailed Employees');
