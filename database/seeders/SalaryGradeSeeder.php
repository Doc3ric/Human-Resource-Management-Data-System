 ...
 * of the National Government — Effective January 1, 2025
 * Source: Annex A (DBM Circular)
 */
class SalaryGradeSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Monthly Salary Rates per Grade => [Step1 .. Step8]
        // SG 33 only has Steps 1 and 2.
        $rates = [
        ...
        DB::table('salary_grades')->insert($rows);
    }
}
