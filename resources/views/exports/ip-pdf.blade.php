...
<head>
<meta charset="utf-8">
<title>IP Personnel Report</title>
<style>
...
<body>
<h1>Indigenous People (IP) Personnel Report</h1>
<div class="sub">Indigenous Peoples (IP) in Filled Plantilla Positions &nbsp;|&nbsp; As of {{ now()->format('F d, Y') }} &nbsp;|&nbsp; {{ $ipRecords->count() }} record(s)</div>
...
<table>
    <thead>
        <tr>
            ...
            <th>Name</th>
            <th style="width:130px;">IP Group</th>
            <th>Office / Unit</th>
    ...
    <tbody>
        ...
        @empty
        <tr><td colspan="7" style="text-align:center; color:#9ca3af; padding:16px;">No IP personnel found.</td></tr>
        @endforelse
    </tbody>
</table>
