...
<div>
    <h2 class="page-title">Generate Tardy Letter</h2>
    <p class="page-subtitle">Generate a formal notice letter for employee tardiness records.</p>
    ...
    <div x-data="{
        ...
        <form method="POST" action="{{ route('leave-violations.store-letter') }}">
            @csrf
            <input type="hidden" name="letter_type" value="HABITUAL_TARDINESS">
            ...
            <div class="form-card">
                ...
                <div class="form-card-body" style="display:flex; gap:24px;">
                    ...
                    <div style="flex:1;">
                        <label class="form-label">No. of Tardiness Occurrences <span>*</span></label>
                        <input type="text" name="occurrences" class="form-control" placeholder="e.g. &quot;three (3)&quot; or &quot;5&quot;" required>
                        <div class="help-text">Appears as: "You have incurred ___ times of tardiness."</div>
                    </div>
                </div>
            </div>
