...
<div class="premium-card">
    <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 24px; border-bottom: 1px solid #e5e7eb; gap: 16px;">
        ...
        <div style="display: flex; gap: 12px; align-items: center; flex-wrap: wrap; justify-content: center;">
            ...
            <a href="{{ route('leave-violations.recorded-entries.create') }}" class="btn btn-sm" style="color: #fff; background: #2563eb; border: 1px solid #2563eb; padding: 8px 16px;"><i class="bi bi-plus-lg"></i> Entry Record</a>
        ...
        <table style="width: 100%; border-collapse: collapse;">
            ...
            <tbody>
                ...
                <tr style="border-bottom: 1px solid #e5e7eb;">
                    ...
                    <td class="nested-td">
                        <div class="avatar-circle">{{ substr($entry->plantillaRecord->first_name, 0, 1) }}</div>
                        <div style="font-size:9px; color:#9ca3af; margin-top:4px;">{{ $entry->reference_no ?? 'LW-'.$entry->id }}</div>
                    </td>
                    
                    <td class="nested-td">
                        <div style="display:flex; gap:4px; justify-content:center;">
                            <button class="table-btn btn-edit"><i class="bi bi-pencil-square"></i> Edit</button>
                            ...
                            <button class="table-btn btn-delete"><i class="bi bi-trash"></i> Delete</button>
                        </div>
                    </td>
                </tr>
                @endforeach
