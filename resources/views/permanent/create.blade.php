<x-dashboard-app>
    <div style="max-width:900px;margin:0 auto;">
        {{-- Header --}}
        <div style="background:linear-gradient(135deg,#052c65,#1e40af);border-radius:14px;padding:22px 28px;margin-bottom:22px;display:flex;align-items:center;justify-content:space-between;gap:16px;">
            <div>
                <h1 style="color:#fff;font-size:20px;font-weight:800;margin:0;">
                    <i class="bi bi-plus-circle-fill me-2"></i>Add Permanent / CT / Elected Record
                </h1>
                <p style="color:rgba(255,255,255,.65);font-size:12px;margin:4px 0 0;">
                    Create a new Permanent, Co-Terminous, or Elected personnel record
                </p>
            </div>
            <a href="{{ session('last_index_url', route('permanent.index')) }}"
