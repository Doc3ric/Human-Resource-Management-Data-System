...
<head>
    ...
    <title>Plantilla Positions - Dashboard</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="page-header">
            <h1>Plantilla Positions</h1>
            <p>Manage plantilla positions and organizational structure</p>
        </div>

        <!-- Content Container -->
        <div class="container-fluid">
            <div class="alert alert-info" role="alert">
                <i class="bi bi-info-circle"></i> Plantilla Positions page - Coming soon
            </div>
        </div>
    </div>
