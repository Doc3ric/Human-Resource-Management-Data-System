    ...
    <div class="content-wrapper p-4">
        <div class="card border-0 shadow-sm" style="border-radius: 12px; max-width: 960px; margin: 0 auto;">
            ...
            <div class="card-body p-4">
                <form action="{{ route('recruitment.store') }}" method="POST" enctype="multipart/form-data" id="recruitmentForm">
                    @csrf
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="name_extension" class="form-control" placeholder="Jr, Sr, III…" value="{{ old('name_extension') }}">
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="indigenous_people" class="form-control" placeholder="Tribe/group or N/A" value="{{ old('indigenous_people') }}">
                        </div>

                        <div class="col-md-12">
                            <label class="form-label fw-semibold" style="font-size:13px;">Address <span class="text-danger">*</span></label>
                            <input type="text" name="address" class="form-control" required value="{{ old('address') }}" list="addresses_list">
                        </div>
                        ...
                        <div class="col-md-7 d-flex align-items-end pb-1 gap-4">
                            <div class="form-check form-switch">
                                ...
                                <label class="form-check-label fw-semibold" for="pgbEmployee" style="font-size:13px;">PGB Employee? (Y/N)</label>
                            </div>
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" name="is_pwd" id="pwd" {{ old('is_pwd') ? 'checked' : '' }}>
                                <label class="form-check-label fw-semibold" for="pwd" style="font-size:13px;">PWD? (Y/N)</label>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="office_input" name="office" class="form-control" required placeholder="Specify office…" value="{{ old('office') }}" list="offices_list">
                        </div>

                        <div class="col-md-4" id="pgbStatusWrapper" style="display:{{ old('is_pgb_employee') ? 'block' : 'none' }};">
                            ...
                            <select name="pgb_status" class="form-select">
                                ...
                                @foreach(['Permanent','Coterminous','Casual','Job Order'] as $s)
                                    <option value="{{ $s }}" {{ old('pgb_status') == $s ? 'selected' : '' }}>{{ $s }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-4">
                            ...
                            <select name="highest_educational_attainment" class="form-select" required>
                                ...
                                @foreach([
                                    ...
                                    <option value="{{ $opt }}" {{ old('highest_educational_attainment') == $opt ? 'selected' : '' }}>{{ $opt }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-semibold" style="font-size:13px;">Course</label>
                            <input type="text" name="degree" class="form-control" placeholder="e.g. BS Information Technology" value="{{ old('degree') }}" list="degrees_list">
                        </div>

                        <div class="col-md-4">
                            <label class="form-label fw-semibold" style="font-size:13px;">Eligibility</label>
                            <input type="text" name="eligibility" class="form-control" placeholder="e.g. Career Service Professional" value="{{ old('eligibility') }}" list="eligibilities_list">
                        </div>
                        
                        <div class="col-md-8">
                            <label class="form-label fw-semibold" style="font-size:13px;">Attach Application Letter (PDF/JPG/PNG) <span class="text-danger">*</span></label>
                            <input type="file" name="application_letter" class="form-control" accept=".pdf,.jpg,.jpeg,.png" onchange="document.getElementById('al_override_block').style.display = this.files.length ? 'none' : '';">
                            @error('application_letter') <div class="text-danger small mt-1">{{ $message }}</div> @enderror

                            <div id="al_override_block" class="mt-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="application_letter_override" id="al_override" value="1" onchange="document.getElementById('al_override_reason_wrap').style.display = this.checked ? '' : 'none';">
                                    <label class="form-check-label" for="al_override" style="font-size:13px;">Override Attachment (no application letter available)</label>
                                </div>
                                <div id="al_override_reason_wrap" style="display:none;" class="mt-2">
                                    <textarea name="application_letter_override_reason" class="form-control" placeholder="Required: reason the application letter is not attached" rows="2">{{ old('application_letter_override_reason') }}</textarea>
                                    @error('application_letter_override_reason') <div class="text-danger small mt-1">{{ $message }}</div> @enderror
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="p-3 border rounded mt-2">
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="url" name="photo_url" class="form-control" placeholder="https://drive.google.com/…" value="{{ old('photo_url') }}">
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input type="url" name="jaf_url" class="form-control" placeholder="https://drive.google.com/…" value="{{ old('jaf_url') }}">
                                </div>
                            </div>
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-md-3">
                                    ...
                                    <input type="text" id="item_no_input" name="item_no" class="form-control" placeholder="Optional" value="{{ old('item_no') }}">
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label fw-semibold" style="font-size:13px;">Salary Grade</label>
                                    <input type="text" id="salary_grade_display" class="form-control" readonly style="background:#f1f5f9;" placeholder="Auto-filled">
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label fw-semibold" style="font-size:13px;">Monthly Rate</label>
                                    <input type="text" id="monthly_rate_display" class="form-control" readonly style="background:#f1f5f9;" placeholder="Auto-filled">
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label fw-semibold" style="font-size:13px;">Date / Time Applied</label>
                                    <input type="datetime-local" name="applied_at" class="form-control" value="{{ old('applied_at') }}">
                                </div>
                            </div>

                            <div id="pgbDetails" style="display:{{ old('is_pgb_employee') ? 'block' : 'none' }};">
                                <h6 class="fw-bold mb-3 text-secondary border-bottom pb-2">
                                ...
                                <div class="row g-3 mb-4 ms-1 ps-3 border-start border-3 border-primary">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="length_of_service" class="form-control" placeholder="e.g. 3 years 2 months" value="{{ old('length_of_service') }}">
                                    </div>
                                    <div class="col-md-8">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="text" name="years_in_present_position" class="form-control form-control-sm" value="{{ old('years_in_present_position') }}">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label" style="font-size:12px;">Permanent</label>
                                        <input type="text" name="years_permanent" class="form-control form-control-sm" value="{{ old('years_permanent') }}">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label" style="font-size:12px;">Coterminous</label>
                                        <input type="text" name="years_coterminous" class="form-control form-control-sm" value="{{ old('years_coterminous') }}">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label" style="font-size:12px;">Casual</label>
                                        <input type="text" name="years_casual" class="form-control form-control-sm" value="{{ old('years_casual') }}">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label" style="font-size:12px;">Job Order</label>
                                        <input type="text" name="years_job_order" class="form-control form-control-sm" value="{{ old('years_job_order') }}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" role="switch" name="has_non_pgb_employment" id="nonPgb"
                                            {{ old('has_non_pgb_employment') ? 'checked' : '' }}
                            ...
                            <div id="nonPgbDetails" style="display:{{ old('has_non_pgb_employment') ? 'block' : 'none' }};">
                                <div class="row g-3 mb-4 ms-1 ps-3 border-start border-3 border-warning">
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" name="np_employment_status" class="form-control" placeholder="e.g. Full-time" value="{{ old('np_employment_status') }}">
                                    </div>
                                    <div class="col-md-4">
                                        <label class="form-label fw-semibold" style="font-size:13px;">Employer / Agency</label>
                                        <input type="text" name="np_employer" class="form-control" value="{{ old('np_employer') }}">
                                    </div>
                                    <div class="col-md-5">
                                        <label class="form-label fw-semibold" style="font-size:13px;">Designation / Position</label>
                                        <input type="text" name="np_designation" class="form-control" value="{{ old('np_designation') }}">
                                    </div>
                                    <div class="col-md-4">
                                        <label class="form-label fw-semibold" style="font-size:13px;">Period (from–to)</label>
                                        <input type="text" name="np_period" class="form-control" placeholder="e.g. Jan 2020 – Dec 2022" value="{{ old('np_period') }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="url" name="tor_url" class="form-control" placeholder="https://drive.google.com/…" value="{{ old('tor_url') }}">
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input type="url" name="eligibility_url" class="form-control" placeholder="https://drive.google.com/…" value="{{ old('eligibility_url') }}">
                                </div>
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input type="url" name="training_url" class="form-control" placeholder="https://drive.google.com/…" value="{{ old('training_url') }}">
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label fw-semibold" style="font-size:13px;">Total Training Hours</label>
                                    <input type="text" name="training_hours" class="form-control" placeholder="e.g. 40 Hours" value="{{ old('training_hours') }}">
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="url" name="experience_url" class="form-control" placeholder="https://drive.google.com/…" value="{{ old('experience_url') }}">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold" style="font-size:13px;">Key Responsibilities / Duties</label>
                                    <textarea name="responsibilities" class="form-control" rows="2" placeholder="Brief description of duties…">{{ old('responsibilities') }}</textarea>
                                </div>
                                
                                <div class="col-md-3">
                                    <label class="form-label fw-semibold" style="font-size:13px;">Latest Performance Rating</label>
                                    <input type="text" name="performance_rating" class="form-control" placeholder="e.g. 4.5 / Outstanding" value="{{ old('performance_rating') }}">
                                </div>
                                <div class="col-md-9">
                                    ...
                                    <input type="url" name="performance_form_url" class="form-control" placeholder="https://drive.google.com/…" value="{{ old('performance_form_url') }}">
                                </div>
                                
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold" style="font-size:13px;">Awards / Recognitions</label>
                                    <textarea name="award" class="form-control" rows="2" placeholder="List of awards or recognitions…">{{ old('award') }}</textarea>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input type="url" name="award_certificate_url" class="form-control" placeholder="https://drive.google.com/…" value="{{ old('award_certificate_url') }}">
                                </div>
                                <div class="col-md-12">
                                    <label class="form-label fw-semibold" style="font-size:13px;">Core Competencies</label>
                                    <textarea name="competencies" class="form-control" rows="2" placeholder="List relevant core competencies…">{{ old('competencies') }}</textarea>
                                </div>
                            </div>
                        </div>
                    </details>
                    ...
                    <div class="alert alert-light border mb-4">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="acknowledged" id="acknowledged" {{ old('acknowledged') ? 'checked' : '' }}>
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-2">
                        ...
                        <button type="submit" class="btn btn-success fw-bold px-4"><i class="bi bi-save me-1"></i> Submit Application</button>
                    </div>
                </form>
            </div>
        </div>
